...
data "template_file" "codebuild_policy" {
  ...
  vars = {
    ...
    subnet_id1                 = element(tolist(module.vpc.public_subnets), 0)
    subnet_id2                 = element(tolist(module.vpc.public_subnets), 1)
    subnet_id3                 = element(tolist(module.vpc.public_subnets), 2)
  }
}
